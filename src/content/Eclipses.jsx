    ...
    return (
        <>
            ...
            <div className="photo-row">
                <img src={`${baseUrl}img/eclipse-lunar-total.jpg`} width="49.5%" />
                <img src={`${baseUrl}img/eclipse-solar-annular.jpg`} width="49.5%" />
            </div>
            <img src={`${baseUrl}img/eclipse-solar-full.jpg`} width="100%" style={{marginTop: "-0.6em"}} />
