...
export const moonPhases = (mainElem) => {
    const width = mainElem.getBoundingClientRect().width;
    return (p) => {
        let moon;
        let angle = -p.HALF_PI;
...
export const moonRevolve = (mainElem) => {
    const width = mainElem.getBoundingClientRect().width;
    return (p) => {
        let earth;
        let moon;
        ...
        p.setup = () => {
            ...
            cam.camera(0, -1000, 0, 0, 0, 0, 0, 0, 1);
...
export const moonQuarters = (mainElem) => {
    const width = mainElem.getBoundingClientRect().width;
    return (p) => {
        let cam;
        let font;
...
export const phaseView = (mainElem, quarter, allowAnimate) => {
    const width = mainElem.getBoundingClientRect().width;
    return (p) => {
        let cam;
        let font;
